...
export function filletCorner(pa, pb, pc, requestedRadius) {
  ...
  let tanPointA = findClosestPointBetweenPoints(circleCenter, pa, pb);
  let tanPointB = findClosestPointBetweenPoints(circleCenter, pc, pb);

  if (flipped) {
    [tanPointA, tanPointB] = [tanPointB, tanPointA];
  }
